...
#define	CS_LOW()	{FIO0CLR0 = _BV(0);}	/* Set P0.6 low */
#define	CS_HIGH()	{FIO0SET0 = _BV(0);}	/* Set P0.6 high */
...
#if FF_FS_READONLY == 0 /*present to max*/
static
